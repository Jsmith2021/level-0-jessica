	...
	public class FruitQuiz extends KeyAdapter {
		...
		void makeQuestions() {
			question1 = new JLabel(
					"<html>Which is a fruit? <br> A: apple <br> B: carrot <br> C: banana</html>");
		...
		public void keyPressed(KeyEvent arg0) {
			...
			if (question1.isShowing()) {
				...
				nextQuestion(question1 = new JLabel(
						"<html>Which one is a vegetable? <br> A: tomato <br> B: potato <br> C: avocado</html>"));
				}
